...
-- Stringifies a list of sublists
printSublists :: [Sublist] -> String
printSublists s = unlines (map formatSublist s)
...
smallestKsets xs k = putStr ("\nEntire list: " ++ show xs ++ "\n\nsize\ti\tj\tsublist\n" ++ printSublists (take k (sortSublists (generateSublists xs))) ++ "\n")
